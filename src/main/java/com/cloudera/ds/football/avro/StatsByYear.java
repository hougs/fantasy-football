...
public class StatsByYear extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StatsByYear\",\"namespace\":\"com.cloudera.ds.football.avro\",\"fields\":[{\"name\":\"year\",\"type\":\"int\"},{\"name\":\"totalGamesPlayed\",\"type\":\"int\"},{\"name\":\"passingStats\",\"type\":{\"type\":\"record\",\"name\":\"StatSummary\",\"fields\":[{\"name\":\"mean\",\"type\":\"double\"},{\"name\":\"variance\",\"type\":\"double\"}]}},{\"name\":\"receivingStats\",\"type\":\"StatSummary\"},{\"name\":\"rushingStats\",\"type\":\"StatSummary\"},{\"name\":\"totalStats\",\"type\":\"StatSummary\"}]}");
   ...
   */
  public StatsByYear(java.lang.Integer year, java.lang.Integer totalGamesPlayed, com.cloudera.ds.football.avro.StatSummary passingStats, com.cloudera.ds.football.avro.StatSummary receivingStats, com.cloudera.ds.football.avro.StatSummary rushingStats, com.cloudera.ds.football.avro.StatSummary totalStats) {
    this.year = year;
  ...
  /** Creates a new StatsByYear RecordBuilder */
  public static com.cloudera.ds.football.avro.StatsByYear.Builder newBuilder() {
    return new com.cloudera.ds.football.avro.StatsByYear.Builder();
  }
  
  /** Creates a new StatsByYear RecordBuilder by copying an existing Builder */
  public static com.cloudera.ds.football.avro.StatsByYear.Builder newBuilder(com.cloudera.ds.football.avro.StatsByYear.Builder other) {
    return new com.cloudera.ds.football.avro.StatsByYear.Builder(other);
  }
  
  /** Creates a new StatsByYear RecordBuilder by copying an existing StatsByYear instance */
  public static com.cloudera.ds.football.avro.StatsByYear.Builder newBuilder(com.cloudera.ds.football.avro.StatsByYear other) {
    return new com.cloudera.ds.football.avro.StatsByYear.Builder(other);
  }
  
  /**
   * RecordBuilder for StatsByYear instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StatsByYear>
    implements org.apache.avro.data.RecordBuilder<StatsByYear> {
    ...
    private Builder() {
      super(com.cloudera.ds.football.avro.StatsByYear.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cloudera.ds.football.avro.StatsByYear.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing StatsByYear instance */
    private Builder(com.cloudera.ds.football.avro.StatsByYear other) {
            super(com.cloudera.ds.football.avro.StatsByYear.SCHEMA$);
      if (isValidValue(fields()[0], other.year)) {
        this.year = data().deepCopy(fields()[0].schema(), other.year);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'year' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setYear(int value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearYear() {
    ...
    /** Sets the value of the 'totalGamesPlayed' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setTotalGamesPlayed(int value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearTotalGamesPlayed() {
    ...
    /** Sets the value of the 'passingStats' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setPassingStats(com.cloudera.ds.football.avro.StatSummary value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearPassingStats() {
      passingStats = null;
    ...
    /** Sets the value of the 'receivingStats' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setReceivingStats(com.cloudera.ds.football.avro.StatSummary value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearReceivingStats() {
      receivingStats = null;
    ...
    /** Sets the value of the 'rushingStats' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setRushingStats(com.cloudera.ds.football.avro.StatSummary value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearRushingStats() {
      rushingStats = null;
    ...
    /** Sets the value of the 'totalStats' field */
    public com.cloudera.ds.football.avro.StatsByYear.Builder setTotalStats(com.cloudera.ds.football.avro.StatSummary value) {
    ...
    public com.cloudera.ds.football.avro.StatsByYear.Builder clearTotalStats() {
      totalStats = null;
    ...
    @Override
    public StatsByYear build() {
      try {
        StatsByYear record = new StatsByYear();
